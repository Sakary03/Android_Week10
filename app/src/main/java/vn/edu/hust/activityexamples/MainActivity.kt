...
class MainActivity : AppCompatActivity() {
  ...
  private val students = mutableListOf(
    Student("Nguyễn Huy Khoa", "20215600"),
    Student("Trần Thị Bảo", "SV002"),
    Student("Lê Hoàng Cường", "SV003"),
    Student("Phạm Minh Đức", "SV004"),
    Student("Nguyễn Thị Hoa", "SV005"),
    Student("Đặng Văn Hưng", "SV006"),
    Student("Vũ Thị Mai", "SV007"),
    Student("Lý Minh Quân", "SV008"),
    Student("Ngô Văn Tùng", "SV009"),
    Student("Đinh Thị Thu", "SV010"),
    Student("Hoàng Minh Phúc", "SV011"),
    Student("Bùi Thị Hạnh", "SV012"),
    Student("Cao Văn Long", "SV013")
  )
